          ...
          <div className="relative">
            ...
            <div className="space-y-4">
              {steps.map((step) => (
                <article
                  key={step.number}
                  className="group relative grid gap-6 border-b border-white/[0.08] py-9 md:grid-cols-[70px_1fr]"
                >
                  <div className="relative z-10">
                    <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[#C9A45C]/40 bg-[#080808]">
