      ...
      <Container>
        <div className="relative">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <Reveal delay={0.1}>
              <h2 className="mx-auto mt-7 max-w-full text-[clamp(2.35rem,10vw,4.5rem)] font-semibold leading-[1.04] text-white md:text-6xl">
                <span className="block md:inline">Human Creativity</span>

                <span className="mx-2 block text-neutral-600 md:mx-3 md:inline">
                  ×
                </span>

                <span className="block break-words text-[#C9A45C] md:inline">
            ...
            <Reveal delay={0.2}>
              <p className="mx-auto mt-8 max-w-2xl px-2 text-base leading-8 text-neutral-400 sm:px-0 sm:text-lg">
          ...
          {/* Central Visual */}
          <Reveal delay={0.25}>
            <div className="group relative mx-auto mt-20 flex min-h-[340px] max-w-4xl items-center justify-center overflow-hidden md:overflow-visible">
              {/* Outer frame */}
              <div className="absolute h-64 w-64 rotate-45 border border-[#C9A45C]/20 transition-transform duration-[1400ms] ease-out group-hover:rotate-[52deg] sm:h-72 sm:w-72" />

              {/* Middle frame */}
              <div className="absolute h-52 w-52 -rotate-12 border border-white/[0.07] transition-transform duration-[1200ms] ease-out group-hover:-rotate-[18deg] sm:h-56 sm:w-56" />

              {/* Inner frame */}
              <div className="absolute h-36 w-36 rotate-[25deg] border border-[#C9A45C]/30 transition-all duration-[1000ms] ease-out group-hover:rotate-[34deg] group-hover:border-[#C9A45C]/50 sm:h-40 sm:w-40" />

              {/* KM Core */}
              <div className="relative z-10 flex h-28 w-28 items-center justify-center rounded-full border border-[#C9A45C]/40 bg-[#080808] shadow-[0_0_100px_rgba(201,164,92,0.12)] transition-all duration-700 ease-out group-hover:scale-105 group-hover:border-[#C9A45C]/70 group-hover:shadow-[0_0_120px_rgba(201,164,92,0.18)] sm:h-32 sm:w-32">
