...
const projects = [
  {
    ...
    gradient:
      "from-[#24180F] via-[#100D0A] to-[#070707]",
  },
  {
    number: "02",
    name: "NordHaus",
    ...
    gradient:
      "from-[#171717] via-[#0D0D0D] to-[#050505]",
  },
  {
    number: "03",
    name: "AutoLux",
    ...
    gradient:
      "from-[#17120C] via-[#0B0B0B] to-[#050505]",
  },
];
      ...
      <Container>
        ...
        <div className="mt-16 space-y-10">
          {projects.map((project, index) => (
            <article
              key={project.name}
              className="group grid overflow-hidden border border-white/[0.08] bg-[#0A0A0A] lg:grid-cols-[1.15fr_0.85fr]"
            >
              {/* Visual */}
              <div
                className={`
              ...
              >
                ...
                <div className="absolute left-1/2 top-1/2 flex h-56 w-56 -translate-x-1/2 -translate-y-1/2 rotate-45 items-center justify-center border border-[#C9A45C]/25 transition-transform duration-700 group-hover:rotate-[52deg] group-hover:scale-105">
                  <div className="h-40 w-40 border border-white/[0.08]" />
                ...
                <div className="absolute bottom-0 left-1/2 h-32 w-64 -translate-x-1/2 bg-[#C9A45C]/10 blur-[80px]" />
              </div>
