...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#050505] pt-20">
      ...
      <Container>
        <div className="relative z-10 flex min-h-[calc(100vh-5rem)] items-center py-12 sm:py-16 lg:py-16">
          <div className="w-full max-w-[760px]">
            ...
            <Reveal delay={0.05}>
              <div className="mb-5 flex items-center gap-3 sm:mb-7 sm:gap-4">
                ...
                <p className="text-[8px] font-medium uppercase tracking-[0.22em] text-[#C9A45C] sm:text-xs sm:tracking-[0.35em]">
            ...
            {/* Headline */}
            <Reveal delay={0.15}>
              <h1 className="max-w-[19rem] text-[2.35rem] font-semibold leading-[1.04] tracking-[-0.025em] text-white min-[390px]:max-w-[21rem] min-[390px]:text-[2.55rem] sm:max-w-3xl sm:text-6xl lg:max-w-4xl lg:text-7xl xl:text-[5.4rem]">
                We Build Brands
            ...
            {/* Description */}
            <Reveal delay={0.25}>
              <p className="mt-6 max-w-[20rem] text-sm leading-7 text-neutral-200 sm:max-w-xl sm:mt-7 sm:text-base sm:leading-8 md:text-lg">
            ...
            {/* CTA */}
            <Reveal delay={0.35}>
              <div className="mt-8 flex max-w-[20rem] flex-col gap-3 sm:mt-9 sm:max-w-none sm:flex-row sm:gap-4">
            ...
            {/* Stats */}
            <Reveal delay={0.45}>
              <div className="mt-12 grid max-w-[20rem] grid-cols-3 border-t border-white/[0.1] pt-6 sm:max-w-xl sm:mt-12 sm:pt-7">
                <div className="pr-3">
